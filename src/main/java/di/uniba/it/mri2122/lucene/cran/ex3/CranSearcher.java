...
public class CranSearcher {
    ...
    private static String customQueryBoost(CranQuery query) {
        return query.getQuery().replace("?", "").replace("*", "").replace("-dash", "").replace("/", "").replace("(", "")
                .replace(")","").replace("theory", "theory^0.9").replace("hypersonic", "hypersonic^1.6").replace("airplane", "airplane^0.4").replace("aircraft", "aircraft^0.6").replace("distribution","distribution^0.3").replace("problem", "problem^0.6").replace("heated", "heated^0.4").replace("speed", "speed^0.3")
                .replace("criterion","criterion^0.3").replace("develop", "develop^0.2").replace("aerodynamic", "aerodynamic^0.3").replace("behaviour","behaviour^0.2").replace("predict", "predict^0.2").replace("shallow","shallow^0.3").replace("existing","existing^0.2").replace("deflection","deflection^0.2").replace("work", "work^0.3").replace("representative","representative^0.2").replace("absence", "absence^0.2").replace("theoretical","theoretical^0.2").replace("kinetic", "kinetic^0.2")
                ...
                .replace("guide", "guide^0.1").replace("obey", "obey^0.1").replace("input", "input^0.1").replace("exist", "exist^0.2").replace("integrate", "integrate^0.2").replace("influence", "influence^0.3").replace("simulation", "simulation^0.3").replace("physical", "physical^0.4").replace("internal", "internal^0.6").replace("magnitude", "magnitude^0.3").replace("dealing", "dealing^0.2")
                .replace("computation", "computation^0.3").replace("generate", "generate^0.2").replace("flexible", "flexible^0.2").replace("stabilize", "stabilize^0.1").replace("modify", "modify^0.1").replace("environment", "environment^0.2")
                .replace("result", "result^0.2").replace("establish", "establish^0.2").replace("accurate", "accurate^0.3").replace("progress", "progress^0.2").replace("freedom", "freedom^0.2").replace("analyse", "analyse^0.2").replace("core", "core^0.2").replace("rational", "rational^0.2").replace("swept", "swept^0.7")
                ...
                .replace("vary", "vary^0.2").replace("maximum", "maximum^0.2").replace("obtainable", "obtainable^0.2").replace("estimate", "estimate^0.2").replace("comparison", "comparison^0.2").replace("reference", "reference^0.2").replace("integral", "integral^0.2").replace("launch", "launch^0.2").replace("hand", "hand^0.2").replace("assume", "assume^0.2").replace("simply", "simply^0.2")
                .replace("normal", "normal^0.2").replace("planform", "planform^0.2").replace("variable", "variable^0.2").replace("minimize", "minimize^0.2").replace("provide", "provide^0.2").replace("insight", "insight^0.2").replace("component", "component^0.2").replace("stall", "stall^0.2").replace("linearise", "linearise^0.1").replace("permit", "permit^0.2").replace("force", "force^0.3")
                .replace("response", "response^0.2").replace("variety", "variety^0.2").replace("utilize", "utilize^0.2").replace("forced", "forced^0.2").replace("closed", "closed^0.2").replace("matching", "matching^0.2")
                .replace("agreement","agreement^0.2").replace("injection", "injection^0.2").replace("portion", "portion^0.1").replace("relationship","relationship^0.1").replace("degree", "degree^0.1").replace("corner", "corner^0.2").replace("factor", "factor^0.2").replace("gradient", "gradient^0.3").replace("procedure", "procedure^0.5").replace("reasonable", "reasonable^0.5");// remove special chars and add term boost
